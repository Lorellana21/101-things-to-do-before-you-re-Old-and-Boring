...
const tasks = [
  ...
  {
    name: "Touch these creatures: Mouse, butterfly, worm, bird, spider, snake, frog, fish, bug",
    completed: false,
  },
  ...
  {
    name: "Get your school involved in a world record attempt",
    completed: false,
  },
  ...
  {
    name: "Fart and Burp in hilariously inappropriate places",
    completed: false,
  },
  ...
  {
    name: "Visit: A safari park, a carnival, a fort, a theme park, a farm, an aquarium, the countryside, another country, a capital city",
    completed: false,
  },
  { name: "Learn to bake a cake", completed: false },
  {
    name: "Hide a treasure and leave a map for friends to find",
    completed: false,
  },
  {
    name: "Learn how to ask someone out (and how to dump them)",
    completed: false,
  },
  ...
  {
    name: "Learn to like (or at least try): broccoli, shellfish, lettuce, brussel sprouts, carrots, smelly cheese, coconut, peas",
    completed: false,
  },
  { name: "Fool someone", completed: false },
  ...
  { name: "Watch these films: https://www.imdb.com/list/ls019137367/", completed: false },
  { name: "Read these books: https://thegreatestbooks.org/", completed: false },
  { name: "Pretend to be ill convincingly", completed: false },
  {
    name: "Save your allowance (or paycheck) for a month and spend it all at once",
    completed: false,
  },
  ...
  {
    name: "Learn to live without something you love for a week",
    completed: false,
  },
  { name: "Join a club", completed: false },
  { name: "Cook a meal", completed: false },
  {
    name: "List the things your parents said they’d tell you when you’re older",
    completed: false,
  },
  ...
  {
    name: "Learn to use long words (and drop them in everyday conversation)",
    completed: false,
  },
  ...
  {
    name: "Glue coins to the floor (and trick people in to trying to pick them up)",
    completed: false,
  },
...
function refreshNumbers() {
  ...
  const results = `You have ${total} tasks to do. <br>You have already achieved "${completed}". You still have "${left}" to complete.`;
  textElement.innerHTML = `<p>${results}</p>`;
}
